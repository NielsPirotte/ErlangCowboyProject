...
loop(Bestuurder , Vervoer , Duur, Locatie,Toplevel,Ongeluk ,NieuweDuurdoorOngeluk) ->
  ...
  receive
    ...
    {gaNaarErgens}-> Bestuurder!{sms},
      erlang:send_after(Duur , self(), {gearriveerd}),Vervoer!{setRijd, true,Toplevel},Vervoer!{setBestuurder,Bestuurder,Toplevel}, loop(Bestuurder , Vervoer, Duur,Locatie,Toplevel,Ongeluk,NieuweDuurdoorOngeluk);

    {gearriveerd} -> if(Ongeluk == false) -> io:format("gearriveerd met : ~p op ~p \n",[Bestuurder,Locatie]) , Toplevel!{log,"gearriveerd", [Bestuurder,Vervoer]},
      Bestuurder!{verplaats, Vervoer, Locatie, Toplevel},Vervoer!{setRijd , false,Toplevel},loop(Bestuurder,Vervoer,Duur,Locatie,Toplevel,Ongeluk,NieuweDuurdoorOngeluk);
                       true -> erlang:display("ongeluk"),erlang:send_after(NieuweDuurdoorOngeluk,self(),{setOngeluk , false}) , erlang:send_after(NieuweDuurdoorOngeluk,self(),{gearriveerd}),
                         loop(Bestuurder,Vervoer,Duur,Locatie,Toplevel,Ongeluk,NieuweDuurdoorOngeluk)
                     end;
